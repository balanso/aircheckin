...
$this->setCssFile($this->_assetsFolder . 'css/grocery-crud-v2.7.8.a4867fc.css');
...
$this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-v2.7.8.a4867fc' . $minify_or_not . '.js');
